...
def processar_arquivo():
    ...
    if not prefixo:
        messagebox.showerror("Erro", "Prefixo do nome do arquivo não fornecido.")
        return
    label_status.config(text="Aguarde...")
...
def obter_prefixo():
    ...
    entry_prefixo.pack(pady=10)

    button_processar = tk.Button(root, text="Processar", command=processar_arquivo)
